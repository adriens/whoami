...
Enseignement exercé entièrement sur temps personnel, le soir après le travail. Conception et animation du module Interopérabilité des Systèmes d'Information en Master MIAGE. Approche pédagogique inspirée de Montessori : learning by doing, projets réels open source et open data, syllabus public sur GitHub, ressources cloud publiques. Feedbacks et suivi de promotion gérés en données (repo GitHub dédié). Renouvelé pour une 2ème session, août → décembre 2026.
