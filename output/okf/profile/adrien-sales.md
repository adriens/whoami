...
type: Profile
title: Adrien Sales
description: Architecte et urbaniste des SI au croisement des maths (DEA INRIA Sophia
  Antipolis) et de la data science (Mastère MSBDS — labellisé Conférence des Grandes
  Écoles), je reconnais la famille de problèmes derrière chaque demande pour structurer
  le SI interne (knowledge graph, lakehouse, bus applicatif) ou API-fier l'existant
  public (open data → SDK → API → écosystème communautaire) — innovation frugale comme
  levier.
...
- [LinkedIn](https://linkedin.com/in/adrien-sales/)
- [Dev.to](https://dev.to/adriens/)
- [YouTube](https://www.youtube.com/channel/UCcbQ_euR84DKOf_-ksI5_GQ)
- [Kaggle](https://www.kaggle.com/adriensales)
- [X (Twitter)](https://twitter.com/rastadidi)
- [PyPI](https://pypi.org/user/rastadidi/)
- [Goodreads](https://www.goodreads.com/user/show/124105866-adrien)
- [HuggingFace](https://huggingface.co/rastadidi)
- [Chocolatey](https://community.chocolatey.org/profiles/adriens)
- [Hackster.io](https://www.hackster.io/adriensales)
- [Docker Hub](https://hub.docker.com/u/rastadidi)
- [Ko-fi](https://ko-fi.com/rastadidi)
- Zenodo: adriens
