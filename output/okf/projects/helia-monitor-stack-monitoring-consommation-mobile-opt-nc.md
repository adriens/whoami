---
type: Project
title: Helia Monitor — Stack monitoring consommation mobile OPT-NC
description: 'Stack personnelle de monitoring de l''offre mobile Helia (OPT-NC) :
  APK reverse-engineered pour extraire les appels HTTP privés, Go CLI qui snapshote
  voice/data…'
resource: https://dev.to/adriens/i-reverse-engineered-my-mobile-operators-apk-then-hermes-agent-wrote-the-executive-report-2j3o
tags:
- go
- duckdb
- python
...
- Clip role-playing dédié : personas lean/agile (CEO, CIO, CTO, sysadmin, dev, marketing, client final) joués par HERMES pour générer un executive summary one-pager — https://youtu.be/RxqDZKXxWyY
- Manifeste Open Innovation NC (< 1') — appel à l'innovation collective pour tous les devs, makers et startups calédoniennes — https://youtu.be/krLwHwx1AeY
