---
name: schemacrawler-additional-command-lints-as-csv
url: https://github.com/adriens/schemacrawler-additional-command-lints-as-csv
description: "An additional command for schemacrawler to dump lints as csv files and produce analytics"
language: Java
topics: [csv, elasticsearch, kibana, database, lint, dashoard, logstash, schemacrawler]
stars: 2
