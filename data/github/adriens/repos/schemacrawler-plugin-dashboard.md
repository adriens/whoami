---
name: schemacrawler-plugin-dashboard
url: https://github.com/adriens/schemacrawler-plugin-dashboard
description: "Schemacrawler plugin that exports lint reports as csv"
language: Java
topics: []
stars: 1
